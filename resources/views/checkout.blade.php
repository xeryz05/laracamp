                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{route('success_checkout')}}" class="basic-form">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control shadow" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                            ...
                            <button type="submit" class="w-100 btn btn-primary shadow">Pay Now</button>
